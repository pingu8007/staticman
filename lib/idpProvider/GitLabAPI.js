...
class GitLabAPI extends GeneralOIDC {
   ...
   */
  constructor(config) {
    config.discovery = config.discovery || "https://gitlab.com/.well-known/openid-configuration"
    ...
    super(config).then(instance => {
      instance.ERROR_GET_CURRENT_USER = 'GET_GITLAB_USER_API'
      return instance
    })
  }
